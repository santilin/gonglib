...
public:
    socias::MasterTable *getFicProyecto() const {
        return pFicProyecto;
    }
    socias::MasterTable *getFicMiembro() const {
        return pFicMiembro;
    }
    socias::MasterTable *getFicTipoSocia() const {
        return pFicTipoSocia;
    }
    socias::MasterTable *getFicPartidaProyecto() const {
        return pFicPartidaProyecto;
    }
...
#endif
#ifdef HAVE_FACTUMODULE
    factu::FactuModule *getFactuModule() const {
        return pFactuModule;
    }
#endif
private:
