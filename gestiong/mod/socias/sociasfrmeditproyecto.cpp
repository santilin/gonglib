/*<<<<<COPYLEFT*/
/** @file sociasfrmeditproyecto.cpp Fichero de edición de proyectos
    ...
    : FrmEditRecMaster( parentfrm, master, dm, editmode, editflags, parent, name, fl )
{
    ...
    comboSociasEstado = addComboField<int>( pControlsFrame, "PROYECTO", "SOCIASESTADO", proyectoFechasLayout );
    ...
    comboPeriodicidad = addComboField<int>( pControlsFrame, "PROYECTO", "PERIODICIDAD", proyectoCuotasLayout );
