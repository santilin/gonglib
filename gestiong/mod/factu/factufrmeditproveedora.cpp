/*<<<<<COPYLEFT*/
/** @file factufrmeditproveedora.cpp Fichero de edición de proveedoras
...
// FIELD FormaPago_ID Reference(pagos::FormaPago,Codigo,Nombre,dbApplication::InsertIfNotFound) - formapago
// FIELD NombreAlt string
// FIELD Agente_ID Reference(Agente,Codigo,RazonSocial,dbApplication::InsertIfNotFound) - agente
    ...
    : FrmEditRecMaster( parentfrm, master, dm, editmode, editflags, parent, name, fl )
{
    ...
    comboIVADetallado = addComboField<int>( pControlsFrame, "PROVEEDORA", "IVADETALLADO", agenteLayout );
...
#endif
    comboGenCodArticulo = addComboField<int>( frameGenCodArt, "PROVEEDORA", "GENCODARTICULO", gencodarticuloLayout );
