/*<<<<<COPYLEFT*/
/** @file factufrmeditpresupuestoventa.cpp Fichero de edición de presupuestos de venta
    ...
    : FrmEditRecMaster( parentfrm, master, dm, editmode, editflags, parent, name, fl )
{
    ...
    comboIVADetallado = addComboField<int>( pControlsFrame, "PRESUPUESTOVENTA", "IVADETALLADO", cabeceraLayout );
