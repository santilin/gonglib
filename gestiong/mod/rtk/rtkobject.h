...
public:
    ...
    void setOrigValue(const char * value )		{
        propValue.setOrig(value);
    }
    const char * formulaBefore() const {
        return propFormulaBefore.get();
    }
    void setOrigFormulaBefore(const char * formulabefore )		{
        propFormulaBefore.setOrig(formulabefore);
    }
    const char * formulaAfter() const {
        return propFormulaAfter.get();
    }
    void setOrigFormulaAfter(const char * formulaafter )		{
        propFormulaAfter.setOrig(formulaafter);
    }
    AggregateType aggregate() const {
        return propAggregate.get();
    }
    void setOrigAggregate(const char * aggregate )		{
        propAggregate.setOrig(aggregate);
    }
    Measure posX() const {
        return propPosX.get();
    }
    void setOrigPosX(const char * posx )		{
        propPosX.setOrig(posx);
    }
    Measure posY() const {
        return propPosY.get();
    }
    void setOrigPosY(const char * posy )		{
        propPosY.setOrig(posy);
    }
    Measure sizeX() const {
        return propSizeX.get();
    }
    void setOrigSizeX(const char * sizex )		{
        propSizeX.setOrig(sizex);
    }
    Measure sizeY() const {
        return propSizeY.get();
    }
    void setOrigSizeY(const char * sizey )		{
        propSizeY.setOrig(sizey);
    }
    const char * style() const {
        return propStyle.get();
    }
    void setOrigStyle(const char * style )		{
        propStyle.setOrig(style);
    }
    ...
    void setOrigTag(const char * tag )		{
        propTag.setOrig(tag);
    }
    Measure marginLeft() const {
        return propMarginLeft.get();
    }
    void setOrigMarginLeft(const char * marginleft )		{
        propMarginLeft.setOrig(marginleft);
    }
    Measure marginRight() const {
        return propMarginRight.get();
    }
    void setOrigMarginRight(const char * marginright )		{
        propMarginRight.setOrig(marginright);
    }
    Measure marginTop() const {
        return propMarginTop.get();
    }
    void setOrigMarginTop(const char * margintop )		{
        propMarginTop.setOrig(margintop);
    }
    Measure marginBottom() const {
        return propMarginBottom.get();
    }
    void setOrigMarginBottom(const char * marginbottom )		{
        propMarginBottom.setOrig(marginbottom);
    }
    bool visible() const;
    void setOrigVisible(const char * visible )		{
        propVisible.setOrig(visible);
    }
    bool supressed() const;
    void setOrigSupressed(const char * supressed )		{
        propSupressed.setOrig(supressed);
    }
    bool supressDup() const;
    void setOrigSupressDup(const char * supressdup )		{
        propSupressDup.setOrig(supressdup);
    }
    ...
    void setOrigFontWeight(const char * fontweight )		{
        propFontWeight.setOrig(fontweight);
    }
    bool fontItalic() const;
    void setOrigFontItalic(const char * fontitalic )		{
        propFontItalic.setOrig(fontitalic);
    }
    double minFontSize() const;
    void setOrigMinFontSize(const char * minfontsize )		{
        propMinFontSize.setOrig(minfontsize);
    }
    Adjustment adjustment() const;
    void setOrigAdjustment(const char * adjustment )		{
        propAdjustment.setOrig(adjustment);
    }
    int maxLines() const;
    void setOrigMaxLines(const char * maxlines )		{
        propMaxLines.setOrig(maxlines);
    }
    const char * format() const;
    void setOrigFormat(const char * format )		{
        propFormat.setOrig(format);
    }
    const char * mask() const;
    void setOrigMask(const char * mask )		{
        propMask.setOrig(mask);
    }
    const char * locale() const;
    void setOrigLocale(const char * locale )		{
        propLocale.setOrig(locale);
    }
    Alignment hAlignment() const;
    void setOrigHAlignment(const char * halignment )		{
        propHAlignment.setOrig(halignment);
    }
    Alignment vAlignment() const;
    void setOrigVAlignment(const char * valignment )		{
        propVAlignment.setOrig(valignment);
    }
    Color fontColor() const;
    void setOrigFontColor(const char * fontcolor )		{
        propFontColor.setOrig(fontcolor);
    }
    Color backColor() const;
    void setOrigBackColor(const char * backcolor )		{
        propBackColor.setOrig(backcolor);
    }
    Color borderColor() const;
    void setOrigBorderColor(const char * bordercolor )		{
        propBorderColor.setOrig(bordercolor);
    }
    int borderWidth() const;
    void setOrigBorderWidth(const char * borderwidth )		{
        propBorderWidth.setOrig(borderwidth);
    }
    BorderStyle borderStyle() const;
    void setOrigBorderStyle(const char * borderstyle )		{
        propBorderStyle.setOrig(borderstyle);
    }
    Color borderTopColor() const;
    void setOrigBorderTopColor(const char * bordertopcolor )		{
        propBorderTopColor.setOrig(bordertopcolor);
    }
    int borderTopWidth() const;
    void setOrigBorderTopWidth(const char * bordertopwidth )		{
        propBorderTopWidth.setOrig(bordertopwidth);
    }
    BorderStyle borderTopStyle() const;
    void setOrigBorderTopStyle(const char * bordertopstyle )		{
        propBorderTopStyle.setOrig(bordertopstyle);
    }
    Color borderBottomColor() const;
    void setOrigBorderBottomColor(const char * borderbottomcolor )		{
        propBorderBottomColor.setOrig(borderbottomcolor);
    }
    int borderBottomWidth() const;
    void setOrigBorderBottomWidth(const char * borderbottomwidth )		{
        propBorderBottomWidth.setOrig(borderbottomwidth);
    }
    BorderStyle borderBottomStyle() const;
    void setOrigBorderBottomStyle(const char * borderbottomstyle )		{
        propBorderBottomStyle.setOrig(borderbottomstyle);
    }
    Color borderLeftColor() const;
    void setOrigBorderLeftColor(const char * borderleftcolor )		{
        propBorderLeftColor.setOrig(borderleftcolor);
    }
    int borderLeftWidth() const;
    void setOrigBorderLeftWidth(const char * borderleftwidth )		{
        propBorderLeftWidth.setOrig(borderleftwidth);
    }
    BorderStyle borderLeftStyle() const;
    void setOrigBorderLeftStyle(const char * borderleftstyle )		{
        propBorderLeftStyle.setOrig(borderleftstyle);
    }
    Color borderRightColor() const;
    void setOrigBorderRightColor(const char * borderrightcolor )		{
        propBorderRightColor.setOrig(borderrightcolor);
    }
    int borderRightWidth() const;
    void setOrigBorderRightWidth(const char * borderrightwidth )		{
        propBorderRightWidth.setOrig(borderrightwidth);
    }
    BorderStyle borderRightStyle() const;
    void setOrigBorderRightStyle(const char * borderrightstyle )		{
        propBorderRightStyle.setOrig(borderrightstyle);
    }
    const char * backgroundImage() const;
    void setOrigBackgroundImage(const char * backgroundimage )		{
        propBackgroundImage.setOrig(backgroundimage);
    }
