...
const int TOSTRING_CODE_AND_DESC = 4;
const int TOSTRING_CODE_AND_DESC_WITH_TABLENAME = 5;
...
public:
    ...
    */
    ...
    const dbRecordRelationsList &getRelationsList() const {
        return mRecordRelations;
    }
    dbRecordRelationsList &getRelationsList() {
        return mRecordRelations;
    }
