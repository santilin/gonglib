/*<<<<<COPYLEFT*/
/** @file factufrmeditcliente.cpp Fichero de edición de clientes
    ...
    : FrmEditRecMaster( parentfrm, master, dm, editmode, editflags, parent, name, fl )
{
    ...
    comboIVADetallado = addComboField<int>( tabExtra, "CLIENTE", "IVADETALLADO", tipoLayout );
    comboTipoCliente = addComboField<int>( tabExtra, "CLIENTE", "TIPOCLIENTE", tipoLayout );
