/*<<<<<COPYLEFT*/
/** @file factufrmeditfacturaventa.cpp Fichero de edición de facturas de venta
    ...
    : FrmEditRecMaster( parentfrm, master, dm, editmode, editflags, parent, name, fl )
{
    ...
    comboIVADetallado = addComboField<int>( pControlsFrame, "FACTURAVENTA", "IVADETALLADO", cabecera2Layout );
