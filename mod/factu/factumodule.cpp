/*<<<<<COPYLEFT*/
/** @file factumodule.cpp Módulo de facturación de gonglib
...
/*>>>>>FACTUMODULE_INITMAINWINDOW_MENUS*/
    ...
    pMenuFactuMod303 = new QAction( toGUI("Modelo 303..."), 0, pMainWindow,0);
    pMainWindow->connect(pMenuFactuMod303, SIGNAL(activated()), this, SLOT(slotMenuFactuMod303()));
                                ...
                                const Xtring &sexcludedtables, const Xtring &sexcludedfields )
{
    ...
    if( dest->isEmpty( "EMPRESA_ID,EJERCICIO,FECHA" ) ) {
        ...
        LineEdit *le = static_cast<LineEdit *>(masterform->findControl( "TIPODOC.CODIGO" ) );
        if( le )
