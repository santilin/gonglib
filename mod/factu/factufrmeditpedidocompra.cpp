    ...
    : FrmEditRecMaster( parentfrm, master, dm, editmode, editflags, parent, name, fl )
{
    ...
    comboIVADetallado = addComboField<int>( pControlsFrame, "PEDIDOCOMPRA", "IVADETALLADO", cabecera2Layout );
    ...
    comboEstadoPedido = addComboField<int>( pControlsFrame, "PEDIDOCOMPRA", "ESTADOPEDIDO", cabecera2Layout );
